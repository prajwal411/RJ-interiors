...
export const metadata = {
  title: "Our Projects | RJ INTERIORS & CONSTRUCTIONS",
  description:
    "Explore RJ INTERIORS' portfolio of completed GRC & FRP construction projects across residential, commercial, and industrial sectors.",
}
...
export default function ProjectsPage() {
  return (
    <div className="flex min-h-screen flex-col page-transition">
      ...
      {/* Hero Section */}
      <section className="relative h-[300px] sm:h-[400px] w-full overflow-hidden mt-20">
        <div className="absolute inset-0 bg-black/60 z-10" />
        <Image
          src="/images/project-1.png"
          alt="GRC & FRP Construction projects"
          fill
        ...
        <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/90 max-w-xl sm:max-w-2xl">
            Explore our portfolio of successful GRC & FRP projects that showcase our expertise and commitment to
            excellence.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 md:mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-base md:text-lg text-gray-700">
              Browse through our diverse portfolio of completed GRC & FRP projects across various sectors.
            </p>
          </div>
            ...
            <Tabs defaultValue="all" className="mb-8 md:mb-12">
              <div className="flex justify-center overflow-x-auto pb-2 -mx-4 px-4">
                <TabsList className="flex space-x-2 p-1 rounded-lg bg-gray-100 dark:bg-gray-800">
                  ...
                  <TabsTrigger value="architectural" className="px-4 py-2 text-sm rounded-md">
                    Architectural
                  </TabsTrigger>
                </TabsList>
              </div>
              ...
              <TabsContent value="architectural" className="mt-6 md:mt-8">
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                  {projects
                    .filter((project) => project.category === "Architectural")
                    .map((project, index) => (
                      <ProjectCard key={index} project={project} />
                    ))}
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center max-w-6xl mx-auto">
            <div>
              ...
              <p className="text-base md:text-lg text-gray-700 mb-6">
                Every GRC & FRP project we undertake follows a rigorous process to ensure quality, timeliness, and
                client satisfaction.
              </p>
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm md:text-base">
                      We source only the highest quality GRC & FRP materials to ensure durability and longevity.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
            ...
            <div className="relative h-[300px] sm:h-[400px] md:h-[500px] rounded-2xl overflow-hidden shadow-xl mt-8 md:mt-0">
              <Image
                ...
                alt="GRC & FRP Construction process"
                fill
                className="object-cover"
      ...
      <section className="py-12 md:py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <p className="text-gray-300 text-sm sm:text-base md:text-lg max-w-xl md:max-w-2xl mx-auto mb-6 md:mb-10">
            Contact us today to discuss how we can bring your GRC & FRP vision to life with the same excellence
    ...
    <Card className="overflow-hidden group h-full">
      ...
      <CardFooter className="p-4 md:p-6 pt-0">
        <Link href="/#contact">
          <Button
            variant="outline"
            className="border-amber-500 text-amber-500 hover:bg-amber-500 hover:text-white text-sm sm:text-base bg-transparent"
          >
            Get Quote
            <ArrowRight className="ml-2 h-4 w-4" />
          </Button>
...
const projects = [
  {
    id: "luxury-villa-facade",
    title: "Luxury Villa GRC Facade",
    category: "Residential",
    description:
      "Elegant GRC facade elements for a luxury villa featuring intricate architectural details and weather-resistant finish.",
    image: "/images/project-1.png",
  },
  {
    id: "commercial-complex-jalis",
    title: "Commercial Complex Jalis",
    category: "Commercial",
    description: "Custom designed GRC jalis for a modern commercial complex providing privacy and aesthetic appeal.",
    image: "/images/project-2.png",
  },
  {
    id: "heritage-dome-restoration",
    title: "Heritage Dome Restoration",
    category: "Architectural",
    description:
      "Restoration of heritage dome using advanced GRC techniques while preserving original architectural character.",
    image: "/images/project-3.png",
  },
  {
    id: "industrial-frp-panels",
    title: "Industrial FRP Panels",
    category: "Industrial",
    description: "Corrosion-resistant FRP panels for industrial facility with superior durability and low maintenance.",
    image: "/images/project-4.png",
  },
  {
    id: "modern-office-columns",
    title: "Modern Office Columns",
    category: "Commercial",
    description:
      "Contemporary GRC columns for modern office building combining structural integrity with aesthetic design.",
    image: "/images/project-5.png",
  },
  {
    id: "residential-decorative-elements",
    title: "Residential Decorative Elements",
    category: "Residential",
    description: "Custom GRC decorative elements for residential project including cornices, brackets, and moldings.",
    image: "/images/project-6.png",
  },
  {
    id: "temple-architectural-work",
    title: "Temple Architectural Work",
    category: "Architectural",
    description: "Intricate GRC work for temple architecture featuring traditional designs with modern durability.",
    image: "/images/industrial-1.png",
  },
  {
    id: "hotel-facade-cladding",
    title: "Hotel Facade Cladding",
    category: "Commercial",
    description:
      "Comprehensive GRC facade cladding for luxury hotel with weather-resistant and fire-retardant properties.",
    image: "/images/residential-2.png",
  },
  {
    id: "warehouse-frp-roofing",
    title: "Warehouse FRP Roofing",
    category: "Industrial",
    description:
      "Lightweight FRP roofing solution for large warehouse providing excellent insulation and corrosion resistance.",
